...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	...
	<section class="ftco-about img ftco-section ftco-no-pt ftco-no-pb" id="about-section" style="margin-top:150px;">
    	<div class="container shadow rounded-lg mb-4" data-aos="fade-up" data-aos-duration="2000" style="margin-top:150px;">
    		<div class="row ">
			<div class="col-lg-12">
			<h2 class="text-center mt-2">View Teacher</h2>
...
<h2 class="text-cebter">Teachers</h2>
<div class ="row">
<?php
if(isset($_POST['submit']))
{
	$branch=$_POST['branch'];
	$query="select t_name,t_email,t_pic from teacher where branch_id='$branch'";
...
?>
<!--
  <div class="col-lg-3 your-element"  data-aos="fade-up" data-aos-duration="2000">
  <div class="card">
	<img class="card-img-top my-3 mx-auto" src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['t_pic']); ?>" alt="Card image" style="max-height:200px;max-width:200px;">
      <div class="card-body">
        <h4 class="card-title text-center"><?php echo $row['t_name'] ;?></h4>
        <h5 class="card-title text-center"> <?php echo $row['t_email'];?></h5>
     </div>
   </div>
 </div>
</div>
