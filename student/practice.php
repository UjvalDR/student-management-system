	...
	<section class="ftco-section" id="ass-section">
    	<div class="container-fluid px-md-5">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
    		...
    		<div class="row ">
<?php 
	$query="select a.ass_name,a.sub_code,a.due,s.sub_name,a.ass_loc,t.t_name,t.t_pic from assignment a,subjects s,student s1,semsec ss,teacher t where s.sub_code=a.sub_code and a.teacher_id = t.teacher_id and ss.sem=s.sem and s1.ssid=ss.ssid and s1.usn='$usn'"; 
